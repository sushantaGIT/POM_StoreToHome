...
import com.store.qa.util.WebEventListener;
...
public class TestBase {
	...
	public TestBase() {
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir")+ "/src/main/java/com/store"
	...
	public static void initialization() {
		...
		if(browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver", "D:\\BAPUN\\EclipseProject\\Drivers\\chromedriver.exe");	
